...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            m = strategy0(score0,score1)
            score0 = update(m,score0,score1,dice)
        else:
            n = strategy1(score1,score0)
            score1 = update(n,score1,score0,dice)
        who = 1 - who
    # END PROBLEM 5
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    original = score
    x = square_update(0, score, opponent_score)
    if x - original >= threshold:
        return 0
    else:
        return num_rolls
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    original = score
    x1 = tail_points(opponent_score)
    x2 = square_update(0, score, opponent_score)
    if x1 >= 9:
        return 0
    elif x2-original>=9:
        return 0
